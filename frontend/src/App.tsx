import './App.css'
  ...
  const bandNames = [
    {name: "Dire Straits", members: "Mark Knopfler, David Knopfler, John Illsley, Pick Withers", formed: 1997},
    ...
    {name: "Traffic", members: "Steve Winwood, Jim Capaldi, Chris Wood, Dave Manson", formed: 1967}
  ];

function Welcome(){
  return <h1>Underrated Bands</h1>;
}
